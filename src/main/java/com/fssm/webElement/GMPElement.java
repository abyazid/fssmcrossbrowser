...
public class GMPElement {

    @FindBy(how = How.CSS, using = ".nav-item:nth-child(3) > .text-uppercase")
    public WebElement gmpLink;
    ...
    public WebElement alamatPemprosesan;
    ...
    public WebElement emel;

    @FindBy(how = How.ID, using = "mobilePhone")
    public WebElement noTelefon;

    @FindBy(how = How.ID, using = "dateImplementGmp")
    public WebElement tarikhPerlaksanaanGMP;

    @FindBy(how = How.NAME, using = "totalStaff")
    public WebElement bilPekerja;
    ...
    public WebElement reasonApplication;

    @FindBy(how = How.XPATH, using = "//button[contains(text(),'Tambah Produk')]")
    ...
    @FindBy(how = How.XPATH, using = "//*[@formcontrolname='labelProduct']")
    ...
    @FindBy(how = How.XPATH, using = "//button[contains(text(),'Tambah OEM')]")
    ...
    public WebElement alamat1_oem;

    @FindBy(how = How.ID, using = "_address2_")
    public WebElement alamat2_oem;

    @FindBy(how = How.ID, using = "_address3_")
    public WebElement alamat3_oem;

    @FindBy(how = How.ID, using = "_postcode_")
    public WebElement poskod_oem;

    @FindBy(how = How.ID, using = "_city_")
    public WebElement bandar_oem;

    @FindBy(how = How.ID, using = "_state_")
    public WebElement negeri_oem;

    @FindBy(how = How.ID, using = "_district_")
    public WebElement daerah_oem;
